# Flight & Hotel A2A Agent — Google ADK

A Google ADK travel agent exposed through the Agent2Agent (A2A) protocol and backed by remote flight
...
- [ADK agent documentation](https://github.com/shashikanth-gs/flight-hotel-mcp-a2a-agents/tree/main/agents/adk)
- License: Apache-2.0
